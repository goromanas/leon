...
class HomePageComponent extends React.Component<Props, State> {
  ...
  public render(): React.ReactNode {
    const { userRoles, allLessons, currentLesson, schedule } = this.props;
        ...
        <Content>
          <PageContent>
            ...
            {userRoles.includes("ADMIN") ? (
              ...
              <DayLessonsList userRole={this.props.userRoles} currentLesson={currentLesson} allLessons={allLessons || []} date={moment().format("YYYY-MM-DD")} day={this.state.dayOfWeek} schedule={schedule} />
            )}
          </PageContent>
        </Content>
      </Layout>
