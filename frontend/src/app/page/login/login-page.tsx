          ...
          <PageContent>
            <Row className={styles.loginContainer}>
              <div>
                ...
                <span>Learning Online</span>
              </div>
              <LoginForm initialValues={LoginPageComponent.LOGIN_INITIAL_VALUES} onSubmit={this.handleSubmit} validate={LoginPageComponent.validate} />
            </Row>
