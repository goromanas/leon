...
class NavigationService {
  ...
  public readonly redirectToCalendarPage = (): string => NavigationService.USER_TIMETABLE_PATH;

  // public readonly redirectToDefaultPage = (): void => {
  //     window.location.href = NavigationService.HOME_PATH;
  // };
  public readonly redirectToDefaultPage = (): string => NavigationService.HOME_PATH;

  public readonly redirectToDefaultPageAfterLogin = (): string => (window.location.href = NavigationService.HOME_PATH);

  // public readonly redirectToChatRoom = (): void => {
  //     window.location.href = NavigationService.CHAT_ROOM_PATH;
  // };

  public readonly redirectToChatRoom = (): string => NavigationService.CHAT_ROOM_PATH;
